...
export const Browse = () => {
  ...
  const searchTitle = (e) => {
    ...
    let arr = finalList.filter(
      (item) => item.title.toUpperCase().lastIndexOf(value) != -1
    );
    setList(arr);
  };
    ...
    <div>
      ...
      <div className="main-contain">
        ...
        <div className="right-side">
          ...
          <button className="button" onClick={() => filterByPrice(0)}>
            Free
          </button>
          <button className="button" onClick={() => filterByPrice(750)}>
            Under ₹750.00
          </button>
          <button className="button" onClick={() => filterByPrice(2250)}>
            Under ₹2,250.00
          </button>
          <br />
          <hr className="hr" />
